...
# Load the GRASSLAND - HAFE dataset
df = pd.read_csv("Bird_Monitoring_Data_GRASSLAND.XLSX - HAFE.csv")
...
plt.title("Top 10 Most Observed Bird Species in Grassland - HAFE")
