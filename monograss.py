...
# Load the GRASSLAND - MONO dataset
df = pd.read_csv("Bird_Monitoring_Data_GRASSLAND.XLSX - MONO.csv")
...
plt.title("Top 10 Most Observed Bird Species in Grassland - MONO")
